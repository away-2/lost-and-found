...
const {
  findTopicListByPaging,
  publishHotTopic,
  changeTopicAuditStatus,
  removeTopicById,
  handleCancelLikeTopic,
  handleLikeTopic,
  findLikeTopicUserList,
  findTopicInfoById,
...
// 发布沸点评论
router.post('/addHotTopicComment',auth, createHotTopicComment)

// 点赞沸点评论
router.get('/likeTopicComment',auth,handleLikeTopicComment)
