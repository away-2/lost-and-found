    ...
    <div class="mainContent">
        <div class="leftWrap">
            <div class="left-item" :class="{ selected: isSelected }">
                <svg t="1708934022437" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="1281" width="19" height="19">
                    <path
                        ...
                        fill="#8a919f" p-id="1282"></path>
                </svg>
                <span>最新</span>
            </div>
            <div class="left-item">
                <svg t="1708934661156" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="1526" width="18" height="18">
                    <path
                        ...
                        fill="#8a919f" p-id="1527"></path>
                </svg>
                <span>热门</span>
            </div>
            <div class="left-item">
                <svg t="1708936396459" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="5014" width="18" height="18">
                    <path
