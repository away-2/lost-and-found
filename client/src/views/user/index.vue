        ...
        <div class="nav-main-wrapper">
            ...
            <div class="info-box">
                ...
                <div class="prefile-box">
                    <svg t="1709274120226" class="icon" viewBox="0 0 1154 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="1316" width="21" height="18">
                        <path
